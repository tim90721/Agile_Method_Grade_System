...
/*****************************************************************************
 * - class TestGetWeight weight
 * 
 * test case1: weight lab1 0.1 lab2 0.1 lab3 0.2 midTerm 0.3 finalExam 0.3 test
 * case2: weight lab1 0.1 lab2 0.2 lab3 0.2 midTerm 0.3 finalExam 0.3 test
 * case2: weight lab1 0.01 lab2 0.2 lab3 0.2 midTerm 0.3 finalExam 0.3
 **************************************************************************** 
 */
...
public class TestUpdateWeight {
	...
	public void testUpdateWeight1() {
		ArrayList<Double> newWeights = new ArrayList<Double>(Arrays.asList(0.1, 0.2, 0.2, 0.2, 0.3));
		SequenceInputStream inContent = new SequenceInputStream(
				new ByteArrayInputStream("10\n20\n20\n20\n30\n".getBytes()), new ByteArrayInputStream("Y".getBytes()));
		System.setIn(inContent);
		assertEquals(true, gradeSystem.updateWeight());
		for (int i = 0; i < 5; i++) {
			assertEquals(newWeights.get(i), gradeSystem.getWeight(i), 0.1);
		}
	}
	...
	public void testUpdateWeight2() {
		...
		// ArrayList<Double> newWeights = new ArrayList<Double>(Arrays.asList(0.1, 0.2,
		// 0.2, 0.3, 0.3));
		SequenceInputStream inContent = new SequenceInputStream(
				new ByteArrayInputStream("10\n20\n20\n30\n30\n".getBytes()), new ByteArrayInputStream("Y".getBytes()));
		System.setIn(inContent);
